...
CategoryDescriptioninstructionsChanges to the skill's prose instructionstoolsScripts, templates, or utilities to add/modifyexamplesExample inputs/outputs to includeerror_handlingGuidance for handling failuresstructureReorganization of skill contentreferencesExternal docs or resources to add
Priority Levels
