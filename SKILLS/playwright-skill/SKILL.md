...
This skill is downstream of the governed package workflow. Use it after acceptance flows, UI surfaces, and test responsibilities are defined in the package, or when the user explicitly asks for browser automation/testing.
