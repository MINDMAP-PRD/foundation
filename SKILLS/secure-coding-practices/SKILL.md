...
This skill is downstream of the governed package workflow. Use it to strengthen contracts, specs, and implementation work after project/package intake is established.
