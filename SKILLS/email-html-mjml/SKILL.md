...
This skill is downstream of the governed package workflow. Use it for email surfaces that already exist in the package or are explicitly requested as standalone email work.
